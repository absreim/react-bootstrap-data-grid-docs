...
<div className="alert alert-info" role="alert">
    This name is legacy name
    that is preserved to maintain backwards compatibility. It will be renamed to
    `PaginationModel` in a future release to be more in line with more recent naming conventions.
</div>
