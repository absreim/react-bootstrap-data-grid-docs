...
import SampleControlledFilteredGrid from "../assets/filtering/SampleControlledFilteredGrid";
import {
...
import SampleUncontrolledFilteredGrid from "../assets/filtering/SampleUncontrolledFilteredGrid";
...
To control which columns are filterable and which are not, simply omit columns from the `filterModel` if you do not
want the user to filter on them.
...
##### SampleControlledFilteredGrid.tsx
...
##### SampleUncontrolledFilteredGrid.tsx
...
<SampleUncontrolledFilteredGrid />
