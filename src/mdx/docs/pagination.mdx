...
import ControlledPaginatedTable from "@/assets/pagination/ControlledPaginatedTable";
import UncontrolledPaginatedTable from "@/assets/pagination/UncontrolledPaginatedTable";
