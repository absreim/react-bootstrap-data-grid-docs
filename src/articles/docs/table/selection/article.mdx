...
import SampleMultiSelectTableContainer from "@/assets/selection/SampleMultiSelectTableContainer";
import SampleSingleSelectTableContainer from "@/assets/selection/SampleSingleSelectTableContainer";
import {
  singleSelectMode,
  multiSelectMode,
} from "@/assets/selection/typeSpecs";

# Selection

react-bootstrap-data-grid provides functionality for the user to select and deselect rows in a `Grid` component.

A `Grid` can be configured to allow or disallow selection. If allowed, it can be configured to either allow selection
