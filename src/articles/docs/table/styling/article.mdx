...
import SampleStyledInputsTable from "./SampleStyledInputsTable";
import SampleStyledTableWrapper from "./SampleStyledTableWrapper";

# Styling

## Methods

There are three primary ways of applying custom styles to the child components of the react-bootstrap-data-grid table:
...
Column widths specified in the [ColDef](/docs/overview/basic-usage#coldef) interface are implemented via
HTML
[style](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes/style) attributes.

#### Table Display Mode

The `displayMode` property of [TableProps](/docs/overview/basic-usage#tableprops) sets the CSS
...
A prop of this type is optionally passed to the `Table` component to enable injection of custom CSS classes.

<TypeSpecTable rows={styleModel}/>

### TableStyleModel

Properties of this type are used to inject custom CSS classes into the main table of the `Table` component.
...
<dl>
    ...
    <dd>
        ...
        of the <code>Table</code> component.
    </dd>
    <dt>
    ...
    <dd>
        ...
        prop passed into the <code>Table</code> component.
    </dd>
</dl>
...
Properties of this type are used to inject custom CSS classes into the filter options table of the `Table` component.
