...
When [pagination](/docs/pagination) is enabled for the grid, the
[pageSelectorJustifyContent](/docs/ref/pagination-options) and [componentSize](/docs/ref/pagination-options)
properties of the [PaginationModel](/docs/ref/pagination-model) interface set the component size and flexbox
...
Column widths specified in the [ColDef](/docs/ref/col-def) interface are implemented via
HTML
[style](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes/style) attributes.

#### Table Display Mode

The `displayMode` property of [TableProps](/docs/ref/table-props) sets the CSS
...
The [StyleModel](/docs/ref/style-model) prop contains a fairly extensive of list of properties that correspond to HTML
elements in various
