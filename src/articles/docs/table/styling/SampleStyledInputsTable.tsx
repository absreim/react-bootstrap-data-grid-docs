...
const styleModel: StyleModel = {
  mainTableStyleModel: {
    ...
    tbodyTdInput: () => ["form-control form-control-sm"],
    editDeleteButton: () => ["btn btn-danger"],
    editSaveButton: () => ["btn btn-success"],
    editCancelButton: () => ["btn btn-warning"],
  },
  ...
  filterInputTableStyleModel: {
    ...
    startDateInput: () => ["form-control form-control-sm"],
    endDateInput: () => ["form-control form-control-sm"],
